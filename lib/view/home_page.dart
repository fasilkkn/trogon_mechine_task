  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ChangeNotifierProvider<CourseViewModel>(
          ...
          child: Consumer<CourseViewModel>(builder: (context, value, _) {
                    ...
                    children: [
                      ...
                      GridView.builder(
                        ...
                        gridDelegate:
                          ...
                          childAspectRatio: 3 /
                              2.5, // Width to height ratio of each grid item
                        ),
                        itemCount: value.courseList.data!.data.subjects.length,
                        itemBuilder: (context, index) {
                          return InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, RoutesName.courseDetail);
                              },
                              child: CourseBox(
                                text: value.courseList.data!.data
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            SeriesBox(
                              color: AppColors.examColorBottom,
                            ),
                            const SizedBox(
                              width: 10,
                            ),
